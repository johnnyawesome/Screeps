...
module.exports = {
    ...
    run: function (creep) {
        ...
        if(hostiles.length > 0){
            ...
            //they have to be named 'Harvest2' or 'Harvest2' etc.
            var flagBoost2 = Game.flags.Boost2;
            var flagHarvest2 = Game.flags.Harvest2;
            ...
            if(flagHarvest2 != undefined){
                ...
                if (creep.room != homeRoom && creep.memory.working == true && roomSwitch == true){
                    creep.moveTo(Game.flags.Boost2, {visualizePathStyle: {stroke: '#ffaa00', opacity: .6, lineStyle: 'dashed'}});
                } 
                
                //if we're in the home room, go explore!!
                if (creep.room != flagHarvest2.room && creep.memory.working == false && roomSwitch == false) creep.moveTo(flagHarvest2);
