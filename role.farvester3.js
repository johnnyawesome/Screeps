...
module.exports = {
    ...
    run: function (creep) {
        ...
        if(hostiles.length > 0){
            ...
            var flagBoost3 = Game.flags.Boost3;
            var flagHarvest3 = Game.flags.Harvest3;
            ...
            if(flagHarvest3 != undefined){
                ...
                if (creep.room != homeRoom && creep.memory.working == true && roomSwitch == true){
                    creep.moveTo(Game.flags.Boost3, {visualizePathStyle: {stroke: '#ffaa00', opacity: .6, lineStyle: 'dashed'}});
                } 
                
                //if we're in the home room, go explore!!
                if (creep.room != flagHarvest3.room && creep.memory.working == false && roomSwitch == false) creep.moveTo(flagHarvest3);
