        ...
        if (creep.memory.working == true) {
            ...
            if (structure != undefined) {
                ...
                if (creep.transfer(structure, RESOURCE_ENERGY) == ERR_NOT_IN_RANGE) {
                    // move towards it
                    creep.moveTo(structure, {visualizePathStyle: {stroke: '#38f400', opacity: .6, lineStyle: 'dashed'}});
                }
            }
        }
        else {
            ...
            if (creep.harvest(source) == ERR_NOT_IN_RANGE) {
                ...
                creep.moveTo(source, {visualizePathStyle: {stroke: '#38f400', opacity: .6, lineStyle: 'dashed'}});
            }
        }
    }
};