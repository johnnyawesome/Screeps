...
module.exports = {
    ...
    run: function (creep) {
        ...
        if(hostiles.length > 0){
            ...
            var flagBoost1 = Game.flags.Boost1;
            var flagHarvest1 = Game.flags.Harvest1;
            ...
            if(flagHarvest1 != undefined){
                ...
                if (creep.room != homeRoom && creep.memory.working == true && roomSwitch == true){
                    creep.moveTo(Game.flags.Boost1, {visualizePathStyle: {stroke: '#ffaa00', opacity: .6, lineStyle: 'dashed'}});
                } 
                
                //if we're in the home room, go explore!!
                if (creep.room != flagHarvest1.room && creep.memory.working == false && roomSwitch == false) creep.moveTo(flagHarvest1, {visualizePathStyle: {stroke: '#ffaa00', opacity: .6, lineStyle: 'dashed'}});
